 ...
 * @author Nam
 */
@WebServlet(name="UpdateAccountServlet", urlPatterns={"/updateA"})
public class UpdateAccountServlet extends HttpServlet {
  ...
  try {
    ...
    throws ServletException, IOException {
        ...
        AccountDAO d = new AccountDAO();
        try {
            Account c = new Account(username  , password ,  fullName,  Integer.parseInt(phone_Number),  birthday,  create_date);
            d.update(c);
        } catch (NumberFormatException e) {
            System.out.println(e);
        }
